    ...
    <Card className='border border-zinc-800 rounded-xl p-4 bg-black text-white h-full'>
      <CardContent className='flex flex-row md:gap-8 gap-4 h-full'>
        ...
        <div className="flex flex-col">
            ...
            <Link className='inline-block w-fit md:text-base text-sm' href={linkHref}><Button className='bg-white text-black hover:bg-zinc-200 transition-all duration-300'>Узнать больше</Button></Link>
        </div>
      </CardContent>
    </Card>
